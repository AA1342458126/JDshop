<template>
    <div class="page">
        ...
        <div class='main'>
            <div class="inputs"><input type="text" placeholder="验证码" v-model="vcode" /><div class="vcode-img" @click="resetCode($event)"><img :src="vcodeUrl" /></div></div>
    ...
    export default {
        ...
        methods:{
            ...
            async submitData(){
                ...
                let vcodeData=await this.checkedCode({vcode:this.vcode});
