        ...
        <div class="index">
            <div class="header">
                <div :class="{top:true,topRed:isHeadRed}">
                    ...
                    <router-link to="/classify" class="top-menu"></router-link>
                    <div class="search-input">
                        <div class="search-icon"></div>
                        <div class="search-text">请输入喜欢的宝贝名称</div>
                    </div>
                    <div class="top-login"><span @click="$router.push('/login')">登录</span></div>
                </div>
            ...
            <div class="main-menu">
                <div class="list" v-for="(item,index) in navs" :key="index">
                    <div class="list-img"><img src="../../../assets/images/common/lazyImg.jpg" :data-echo="item.image" :alt="item.title"></div>
            ...
            <template v-for="(item,index) in goods">
                ...
                <div class="goods" :key="index" v-if="(index+1)%2==1">
                    ...
                    <div class="goods-row-1">
                        ...
                        <div class="right">
                            <div class="goodslist-2" v-for="(item2,index2) in item.items.slice(1,3)">
                    ...
                    <div class="goods-row-2">
                        <div class="goodslist" v-for="(item2,index2) in item.items.slice(3)">
                            <div class="title goodslist1-title-color">{{item2.title}}</div>
                ...
                <div class="goods" :key="index" v-else>
                    ...
                    <div class="goods2-row-1">
                        <div class="goodslist-1" v-for="(item2,index2) in item.items.slice(0,2)">
                    ...
                    <div class="goods2-row-2">
                        <div class="goodslist" v-for="(item2,index2) in item.items.slice(2)">
                            <div class="title goodslist1-title-color">{{item2.title}}</div>
                            <div class="img"><img src="../../../assets/images/common/lazyImg.jpg" :data-echo="item2.image" :alt="item2.title"></div>
                            <div class="price goodslist-price-color">￥{{item2.price}}</div>
                            <div class="unprice goodslist-unprice-color">￥{{item2.price*2}}</div>
            ...
            <div class="recom-area">
                <div :class="(index)%2==0?'goods-list goodsL':'goods-list goodsR'" v-for="(item,index) in recoGoods" :key="index">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getSwiper(){
                // console.log(this.$config.baseApi+"/home/index/slide?token="+this.$config.token);
